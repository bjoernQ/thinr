...
public class BasicFlowTest4 extends TestBase {
    ...
    public void testLambda() throws Exception {
        ...
        Thinr.task(mock(Context.class), "name", BasicFlowTest4.class, String.class)
                ...
                .execute("startParam", "componentB", mockExecutor);

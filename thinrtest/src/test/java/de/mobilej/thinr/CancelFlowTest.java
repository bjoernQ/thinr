...
public class CancelFlowTest extends TestBase {

    @Test
    public void testCancelUnknownTaskShouldNotCrash() throws Exception {
        Thinr.cancel("unknownJob", "theComponent");
    }

    @Test
    public void testCancelInBackground() throws Exception {
        Thinr.task(mock(Context.class), "name", CancelFlowTest.class, String.class)

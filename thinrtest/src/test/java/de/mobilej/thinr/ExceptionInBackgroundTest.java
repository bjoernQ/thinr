...
public class ExceptionInBackgroundTest extends TestBase {

    @Test
    public void testOperation() throws Exception {

        Thinr.task(mock(Context.class), "name", ExceptionInBackgroundTest.class, String.class)
                .inBackground((target, param, flowControl) -> {
